    ...
    <div className="p-4 lg:p-8">
      ...
      <div className="mb-6 lg:mb-8">
        ...
        <div className="flex items-center gap-2 lg:gap-3 mb-2">
          ...
          <h1 className="text-2xl lg:text-3xl font-bold text-white">Gestão de Dependentes</h1>
        </div>
        <p className="text-sm lg:text-base text-zinc-400">Visualize e gerencie todos os usuários dependentes da plataforma</p>
      </div>
      ...
      <div className="bg-[#111827] border border-white/5 rounded-xl overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-zinc-400">Nenhum dependente encontrado</p>
          </div>
        ) : (
          <>
            {/* Mobile Cards View */}
            <div className="lg:hidden divide-y divide-white/5">
              {dependents.map((dependent) => (
                <div key={dependent.id} className="p-4 hover:bg-white/5 transition-colors">
                  {/* Dependent Header */}
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-white font-medium truncate">{dependent.nome}</div>
                      <div className="text-xs text-zinc-400">ID: #{dependent.id}</div>
                      <div className="text-sm text-zinc-300 truncate mt-1">{dependent.email || "Sem email"}</div>
                      {dependent.telefone && (
                        <div className="text-xs text-zinc-400">{dependent.telefone}</div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-3">
                    <div>
                      <div className="text-xs text-zinc-500 mb-1">Principal</div>
                      <div className="text-sm text-white font-medium">{dependent.principal_nome}</div>
                      <div className="text-xs text-zinc-400">ID: #{dependent.usuario_principal_id}</div>
                    </div>
                    <div>
                      <div className="text-xs text-zinc-500 mb-1">Plano</div>

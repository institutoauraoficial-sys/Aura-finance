      ...
      <div className="container mx-auto px-4 py-16 md:py-24 relative z-10 flex-1 flex flex-col justify-center">
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full hover:bg-white/10 transition-colors text-sm"
                title={t('plans.selectLanguage')}
              >
                <Globe className="w-4 h-4 text-zinc-400" />
                <span className="text-white uppercase font-medium">{language}</span>
              </button>
              
              {showLanguageMenu && (
                <div className="absolute right-0 mt-2 bg-[#111827] border border-white/10 rounded-lg shadow-xl z-50 overflow-hidden min-w-[160px]">
                  <button
        ...
        {settings.habilitar_toggle_periodo_planos && (
          <div className="flex justify-center mb-12">
            <div className="inline-flex items-center gap-3 bg-[#111827] border border-white/10 rounded-full p-1.5">
              <button

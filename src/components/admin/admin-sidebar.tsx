  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-40 p-2 bg-[#111827] border border-white/10 rounded-lg text-white hover:bg-white/5 transition-colors"
      ...
      <aside className={cn(
        "w-64 bg-[#111827] border-r border-white/5 flex flex-col",
      ...
      <div className="p-6 border-b border-white/5">
        ...
        <button
          onClick={() => setIsMobileMenuOpen(false)}
          className="lg:hidden absolute top-4 right-4 p-2 text-zinc-400 hover:text-white transition-colors"

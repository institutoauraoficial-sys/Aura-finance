    ...
    <Modal isOpen={isOpen} onClose={onClose} title="">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div>
            <h2 className="text-2xl font-bold text-white">Editar Dependente</h2>
            <p className="text-sm text-zinc-400 mt-1">Atualize as informações do usuário</p>
          </div>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder:text-zinc-500 focus:outline-none focus:border-[#22C55E] transition-colors"
          ...
          <div>
            ...
            <select
              ...
              required
              className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#22C55E] transition-colors"
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder:text-zinc-500 focus:outline-none focus:border-[#22C55E] transition-colors resize-none"
        ...
        <div className="flex flex-col-reverse sm:flex-row gap-3 sm:justify-end">
          ...
          <button
            type="submit"
            disabled={saving}
            className="px-6 py-3 bg-[#22C55E] hover:bg-[#16A34A] text-white rounded-lg font-medium transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {saving ? (
              <>

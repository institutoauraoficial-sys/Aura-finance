      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white">Resetar Senha</h2>
              <p className="text-sm text-zinc-400 mt-1">Defina uma nova senha para o dependente</p>
            </div>
          </div>
          <button
            type="button"
        ...
        <div className="bg-white/5 rounded-xl p-4">
          <p className="text-sm text-zinc-400 mb-2">Resetando senha para:</p>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                minLength={6}
                className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 pr-12 text-white placeholder:text-zinc-500 focus:outline-none focus:border-[#22C55E] transition-colors"
        ...
        <div className="flex flex-col-reverse sm:flex-row gap-3 sm:justify-end">
          ...
          <button
            type="submit"
            disabled={resetting}
            className="px-6 py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-medium transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {resetting ? (
              <>

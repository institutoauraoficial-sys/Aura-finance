      ...
      <div className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 border border-purple-500/20 rounded-xl p-6 space-y-6">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-4">
            ...
            <div className="grid gap-2 text-sm">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <span className="text-zinc-400"> - Ícone da aba do navegador (32x32px)</span>
                </div>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                <div>
                  ...
                  <span className="text-zinc-400"> - Safari alta resolução (96x96px)</span>
                </div>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                <div>
                  ...
                  <span className="text-zinc-400"> - Ícone iOS/Safari (180x180px)</span>
                </div>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <span className="text-zinc-400"> - PWA alta resolução (512x512px)</span>
                </div>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-lg p-4 space-y-3">
            ...
            <ol className="list-decimal list-inside space-y-2 text-sm text-zinc-300 ml-2">
              <li>Localize a pasta: <code className="bg-zinc-800 px-2 py-1 rounded text-purple-300">GranaZap_V5_NEW → granazap → public</code></li>
          ...
          {/* Verificar Deploy */}
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-lg p-4 space-y-3">
            <h4 className="text-white font-medium">✅ Verificar Deploy na Vercel</h4>
            <ol className="list-decimal list-inside space-y-2 text-sm text-zinc-300 ml-2">

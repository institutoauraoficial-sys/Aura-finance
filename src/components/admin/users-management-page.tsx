...
export function UsersManagementPage() {
  ...
  const handleCreateUser = async (userData: any) => {
    ...
    if (result.success) {
      ...
      // Sucesso será tratado pelo modal
    } else {
  ...
  return (
    <div className="p-4 lg:p-8">
      ...
      <div className="mb-6 lg:mb-8">
        ...
        <p className="text-sm lg:text-base text-zinc-400">Visualize e gerencie todos os usuários da plataforma</p>
      </div>
      ...
      {/* Filters Section */}
      <div className="bg-[#111827] border border-white/5 rounded-xl p-4 lg:p-6 mb-6">
      ...
      <div className="bg-[#111827] border border-white/5 rounded-xl p-4 lg:p-6 mb-6">
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-3 lg:gap-4">
          ...
          <div className="flex items-center gap-3">
            {/* Total Count */}
            <div className="text-xs lg:text-sm text-zinc-400 flex-1 lg:flex-initial">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-zinc-400 text-xs lg:text-sm hidden sm:inline">por página</span>
            </div>
            
            {/* Add User Button */}
            <button
              onClick={() => setIsCreateModalOpen(true)}
              className="flex items-center gap-2 bg-[#22C55E] hover:bg-[#16A34A] text-white px-4 lg:px-6 py-2 lg:py-3 rounded-lg font-medium transition-colors text-sm lg:text-base whitespace-nowrap"
            >
      ...
      <div className="bg-[#111827] border border-white/5 rounded-xl overflow-hidden">
        <div className="p-4 lg:p-6 border-b border-white/5">
          <h2 className="text-lg lg:text-xl font-bold text-white">Lista de Usuários</h2>
                ...
                <div key={user.id} className="p-4 hover:bg-white/5 transition-colors">
                  ...
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-white font-medium truncate">{user.nome}</div>
                      <div className="text-xs text-zinc-400">ID: #{user.id}</div>
                      <div className="text-sm text-zinc-300 truncate mt-1">{user.email}</div>
                      {user.celular && (

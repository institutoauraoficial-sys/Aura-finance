    ...
    <div className="space-y-6">
      ...
      <div className="bg-[var(--bg-card)]/50 border border-zinc-800 rounded-xl p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-[var(--text-primary)] font-medium">Habilitar Botão WhatsApp</h3>
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
              habilitado ? 'bg-green-600' : 'bg-[var(--bg-elevated)]'
            }`}
          >
            <span
        ...
        <div className="flex justify-end pt-4">
          <button
            onClick={handleSave}
            disabled={loading}
            className="px-6 py-2 bg-green-600 hover:bg-green-700 text-[var(--text-primary)] rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
      ...
      {habilitado && urlWhatsApp && (
        <div className="bg-[var(--bg-card)]/50 border border-zinc-800 rounded-xl p-6">
          <h3 className="text-[var(--text-primary)] font-medium mb-4">Preview do Botão</h3>
          <div className="bg-[var(--bg-base)] border border-zinc-800 rounded-lg p-4 inline-block">
            <button className="flex items-center gap-3 px-4 py-2 bg-green-600 hover:bg-green-700 text-[var(--text-primary)] rounded-lg transition-colors">

...
// [OFX_DISABLED] import { Upload } from "lucide-react";
...
// [OFX_DISABLED] import { OFXReconciliationModal } from "./ofx-reconciliation-modal";
...
export function CardDetailsPage({ cardId }: CardDetailsPageProps) {
  ...
  // [OFX_DISABLED] const [isOFXModalOpen, setIsOFXModalOpen] = useState(false);

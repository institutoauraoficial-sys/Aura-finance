...
export function FutureTransactionsPage() {
  ...
  }, [transactions, deferredSearchTerm, filterType, filterStatus, filterRecurrence, selectedCategoryId, startDate, endDate, period]);
        ...
        {showFilters && (
          <div className="space-y-4 mt-4 pt-4 border-t border-white/5">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                <label className="text-xs text-zinc-500 mb-2 block">{t('categories.title')}</label>
                <select
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              <div className="flex flex-col items-center gap-3 text-center">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white mb-1">A Receber</h3>
                  <p className="text-xs text-zinc-400">Receitas futuras agendadas</p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex flex-col items-center gap-3 text-center">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white mb-1">A Pagar</h3>
                  <p className="text-xs text-zinc-400">Despesas futuras agendadas</p>
                </div>
              </div>
            </button>
          </div>

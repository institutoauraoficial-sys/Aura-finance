        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-green-500/10 border-2 border-green-500/30 rounded-lg p-4">
            ...
            <div className="space-y-3">
              <div>
                <p className="text-xs text-zinc-500 mb-1">Posição Atual</p>
              ...
              <div>
                <p className="text-xs text-zinc-500 mb-1">Novo Aporte</p>
                <div className="bg-zinc-800/50 rounded p-2 space-y-1">
                  <div className="flex justify-between text-xs">
                    <span className="text-zinc-400">Quantidade:</span>
                    <span className="text-white font-medium">
          ...
          <div className="bg-zinc-800/50 border-2 border-zinc-700 rounded-lg p-4">
            ...
            <div className="space-y-3">
              ...
              <div>
                <p className="text-xs text-zinc-500 mb-1">Nova Posição</p>
                <div className="bg-zinc-800/50 rounded p-2 space-y-1">
                  <div className="flex justify-between text-xs">
                    <span className="text-zinc-400">Quantidade:</span>
                    <span className="text-white font-medium">
              ...
              <div>
                ...
                <div className="bg-zinc-700/30 border border-zinc-600 rounded p-2">

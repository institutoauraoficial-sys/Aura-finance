...
export function PatrimonialOverview() {
  ...
  return (
    <div className="bg-gradient-to-br from-[#111827] to-[#0f1623] border border-white/5 rounded-xl p-6">
      <div className="flex items-center gap-3 mb-6">
        <div className="w-10 h-10 rounded-lg bg-purple-500/10 flex items-center justify-center">
          <Building2 className="w-5 h-5 text-purple-400" />
        </div>
        <h2 className="text-xl font-bold text-white">Visão Patrimonial</h2>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Link 
          ...
          className="space-y-4 group cursor-pointer hover:bg-white/[0.02] rounded-lg p-4 -m-4 transition-colors"
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <CreditCard className="w-5 h-5 text-blue-400 group-hover:text-blue-300 transition-colors" />
              <h3 className="text-sm font-semibold text-zinc-300 group-hover:text-white transition-colors">Cartões de Crédito</h3>
            </div>
            <span className="text-xs text-zinc-500">{activeCardsCount} cartão(ões)</span>
          </div>
                ...
                <div key={card.id}>
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-zinc-300">{card.nome}</span>
                    </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-semibold text-zinc-300 group-hover:text-white transition-colors">Contas Bancárias</h3>
            </div>
            <span className="text-xs text-zinc-500">{activeAccountsCount} conta(s)</span>
          </div>
              ...
              return (
                <div key={account.id}>
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center gap-2">
                      <div className={`w-3 h-3 rounded-full ${color}`} />
                      <span className="text-sm text-zinc-300">{account.nome}</span>
                    </div>
                    <span className="text-sm font-medium text-zinc-400">

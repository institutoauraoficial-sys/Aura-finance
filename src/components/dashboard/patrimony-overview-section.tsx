            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-500">{creditCardData.count} cartão(ões)</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-[#111827] border border-white/5 rounded-xl p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-white">Contas Bancárias</h3>
                  <p className="text-xs text-zinc-500">{accountsData.count} conta(s)</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-[#111827] border border-white/5 rounded-xl p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-white">Investimentos</h3>
                  <p className="text-xs text-zinc-500">{investmentsData.count} ativo(s)</p>
                </div>
              </div>
            </div>

            <div className="mb-4">
              <p className="text-xs text-zinc-400 mb-1">Patrimônio Investido</p>

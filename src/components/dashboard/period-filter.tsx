    ...
    <>
      <div className="relative" ref={dropdownRef}>
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium transition-colors bg-zinc-900/50 border border-zinc-800 text-white hover:bg-zinc-800 min-w-[120px] justify-between"
        >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 rounded-lg bg-[#0A0F1C] border border-white/10 text-white focus:outline-none focus:border-primary [color-scheme:dark]"
                  />
                </div>
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    onClick={() => setShowCustomModal(false)}
                    className="flex-1 px-4 py-2 rounded-lg border border-white/10 text-zinc-400 hover:text-white hover:bg-white/5 transition-colors"
                  >
                    {t('common.cancel')}
                  </button>
                  <button

...
import { Plug, Calendar, CheckCircle2, XCircle, Loader2, ExternalLink, RefreshCw, ChevronDown } from "lucide-react";
  ...
  const fetchIntegration = useCallback(async () => {
    ...
    try {
      const { data, error } = await supabase
        ...
        .select('id, google_email, is_active, connected_at, last_sync_at, calendar_id_pf, calendar_name_pf, calendar_id_pj, calendar_name_pj, sync_enabled_pf, sync_enabled_pj')

    ...
    <div className="space-y-3 md:space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 md:gap-4">
        ...
        <div
          ...
          className={cn(
            "bg-[#111827] border border-white/5 rounded-xl p-4 md:p-6 transition-colors",
            stat.href ? "cursor-pointer hover:border-white/20 hover:bg-[#111827]/80 active:scale-[0.98] transition-all" : "hover:border-white/10"
          )}
        >
          {/* Icon & Change */}

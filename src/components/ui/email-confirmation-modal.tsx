              ...
              <div className="p-8 text-center">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full text-sm text-zinc-400 hover:text-[#22C55E] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {isResending ? (
                      <>

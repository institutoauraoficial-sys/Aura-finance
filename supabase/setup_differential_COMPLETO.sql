...
-- Última Atualização: 28/02/2026 - Feature OFX reativada com toggle no painel admin
...
-- =====================================================
-- Criada em: 09/01/2025 | Atualizada em: 26/02/2026
...
COMMENT ON FUNCTION public.delete_category_safe(INTEGER, INTEGER) IS 'Deleta uma categoria de forma segura. Com migração: p_target_category_id move vínculos antes de deletar. Atualizada em 26/02/2026.';
